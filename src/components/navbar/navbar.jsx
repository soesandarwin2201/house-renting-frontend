            ...
            <ul className="nav-menu" onClick={showSideBar}>
              ...
              <div className="social-container">
                <li className="nav-item">
                  <Link
                    to="https://wellfound.com/u/soe-sandar-win"
                ...
                <li className="nav-item">
                  <Link
                    to="https://www.linkedin.com/in/soe-sandar-win-softwareengineer/"
                    className="social link"
                  >
                    <FaIcon.FaLinkedin />
                  </Link>
                ...
                <li className="nav-item">
                  <Link
                    to="https://github.com/soesandarwin2201"
                    className="social link"
                  >
                    <FaIcon.FaGithub />
                  </Link>
                ...
                <li className="nav-item">
                  <Link
                    to="https://medium.com/@soesandarwin2201"
                    className="social link"
                  >
                    <FaIcon.FaMedium />
                  </Link>
