    ...
    <section id="detail-container">
      ...
      <p id="location">{house?.location}</p>
        ...
        <div className="price-container">
          ...
          <p id="bed-room">{house?.bedroom_number} bds</p>
          </li>
        </div>
        <p id="description"><span className="detail">Detail:</span> {house?.description}</p>
        <button id="reserver-btn" type="button" onClick={() => { navigate(`/houses/${house?.id}/reservations`); }}>Reserve <FcIcon.FcOvertime id="reserve-icon" /></button>
      </div>
      </div>
